...
import static com.NewtonSwerve.ctre.CtreUtils.checkCtreError;
...
import com.NewtonSwerve.SteerController;
...
public final class Falcon500SteerControllerFactoryBuilder {
    ...
    public Falcon500SteerControllerFactoryBuilder withPidConstants(double kP, double kI, double kD) {
        this.kP = kP;
        this.kI = kI;
        this.kD = kD;
        return this;
