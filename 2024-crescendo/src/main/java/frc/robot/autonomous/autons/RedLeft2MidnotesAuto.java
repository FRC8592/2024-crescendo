...
public class RedLeft2MidnotesAuto extends BaseAuto{
    ...
    private SwerveTrajectory shootToMN2 = AutonomousPositions.generate(config.setEndVelocity(0).setStartVelocity(2.5),
            new Pose2d(2.5,4.5,Rotation2d.fromDegrees(180)),
            new Pose2d(3,1.4,new Rotation2d()),
            AutonomousPositions.MID_NOTE_4.translate(-0.75, 0));
    ...
    public void initialize() {
        ...
        queue = new CommandQueue(
                ...
                // Add a midpoint
                new DriveToPointCommand(drive, AutonomousPositions.WING_NOTE_2.getPose(), new Pose2d(2.5,4.5,new Rotation2d()), config.setStartVelocity(0).setEndVelocity(3)),
