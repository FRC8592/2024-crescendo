...
//         liftBuffer = new AddressableLEDBuffer(LEDS.LED_LENGTH);
//         liftNEOPIXELS.setLength(LEDS.LED_LENGTH);
//         liftNEOPIXELS.start(); 
...
//         if ((power.voltage < LEDS.MINIMUM_VOLTAGE || lowVolts) && power.voltage > 0) {
...
//             setColor(LEDS.LED_LENGTH - 1 - i,new Color(0,0,0));
//         }
...
//                     setColor(LEDS.LED_LENGTH - 1 - j, fireBlobs.get(i).getColor());
//                 }
//             }
//         }
//     }
...
//                 PresetColor color = (pipeline == LEDS.CUBE_PIPELINE || pipeline == LEDS.APRILTAG_PIPELINE) ? PresetColor.PURPLE : PresetColor.YELLOW;
...
//         binaryIndex++;
//         for(int i = 0; i < LEDS.LED_LENGTH; i++){
//             setColor(LEDS.LED_LENGTH-i-1,binary[(binaryIndex/6+i)%90]);
//         }
//     }
...
//         double speed = 15;
//         int length = 5;
//         if(snakeTimer.get()*speed<LEDS.LED_LENGTH){
//             location = (int)(snakeTimer.get()*speed);
//             direction=0;
//         }
//         else if (snakeTimer.get()*speed<LEDS.LED_LENGTH*2){
//             location = LEDS.LED_LENGTH-(((int)(snakeTimer.get()*speed))-LEDS.LED_LENGTH)-1;
//             direction=1;
//         }
//         else{
//             snakeTimer.reset();
...
//                 if(location+i<LEDS.LED_LENGTH){
//                     setColor(location+i,getColorAtBrightness(color, i*(1.0/length)));
//                 }
//                 else {
//                     setColor(LEDS.LED_LENGTH-((location+i)-LEDS.LED_LENGTH)-1,getColorAtBrightness(color, i*(1.0/length)));
//                 }
//             }
//         }
//         else{
...
//         for(int i = 0; i < LEDS.LED_LENGTH / 10; i++) {
...
//         waveCounter++;
//         for(int i = 0; i < LEDS.LED_LENGTH / 2; i++) {
//             if(Math.abs(LEDS.LED_LENGTH / 2 + i - indexOn) % LEDS.PULSE_GAP < LEDS.PULSE_SIZE) {
//                 setColor((LEDS.LED_LENGTH / 2 + i), color);
//                 setColor((LEDS.LED_LENGTH / 2 - 1 - i), color);
//             } else {
//                 setColor((LEDS.LED_LENGTH / 2 + i), PresetColor.OFF);
//                 setColor((LEDS.LED_LENGTH / 2 - 1- i), PresetColor.OFF);
//             }
//         }
//         if (waveCounter >= LEDS.PULSE_METHOD_SPEED) {
//             waveCounter = 0;
//             indexOn = (indexOn + 1) % (LEDS.LED_LENGTH / 2);
//         }
//     }
