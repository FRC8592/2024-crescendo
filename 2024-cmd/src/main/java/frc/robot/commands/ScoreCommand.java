...
public class ScoreCommand extends NewtonCommand{
    ...
    public ScoreCommand(BooleanSupplier forceShoot){
         ...
         * way this works is by making sure the cancel-on-false is applied to a sequential WaitUntilCommand
         ...
         */
        super(
            new DeferredCommand(() -> { // <-- Notice that we're starting a lambda here. This will cast to a Supplier<Command>.
