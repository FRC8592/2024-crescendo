...
public class MovingShotThreeWingNoteAuto extends BaseAuto{
    ...
    public void initialize() {
       queue = new CommandQueue(
        ...
        new JointCommand(
            new MovingShotCommand(subsystemsManager, 2, new FollowerCommand(drive, noteTwo_1), getStartPose(), drive), // Spin up the shooter wheels in advance to reduce time-to-shoot
