...
public class NewtonSwerve {
    ...
    public NewtonSwerve(ModuleConfig config, Gyro gyro, SwerveModule frontLeft, SwerveModule frontRight, SwerveModule backLeft, SwerveModule backRight){
        ...
        // set current limits
        this.MAX_SWERVE_DRIVE_AUTO_CURRENT = !Double.isNaN(config.getAutoCurrentLimit()) ? config.getAutoCurrentLimit() : this.MAX_SWERVE_DRIVE_AUTO_CURRENT;
        this.MAX_SWERVE_DRIVE_TELEOP_CURRENT = !Double.isNaN(config.getTeleopCurrentLimit()) ? config.getTeleopCurrentLimit() : this.MAX_SWERVE_DRIVE_TELEOP_CURRENT;
    ...
    // public NewtonSwerve(ModuleConfig config, Gyro gyro, NewtonModule frontLeft, NewtonModule frontRight, NewtonModule backLeft, NewtonModule backRight){
    ...
    public void drive(ChassisSpeeds chassisSpeeds) {
        ...
        this.odometry.update(this.getGyroscopeRotation(), new SwerveModulePosition[] {m_frontLeftModule.getModulePosition(), m_frontRightModule.getModulePosition(), m_backLeftModule.getModulePosition(), m_backRightModule.getModulePosition()});
    }
