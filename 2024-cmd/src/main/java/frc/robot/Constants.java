...
public final class Constants {
    ...
    public final class POWER {
        public static final int INTAKE_MOTOR_CURRENT_LIMIT = 1;
    ...
    public final class INTAKE {
        ...
        public static final double MOTOR_kFF = 0;
    ...
    public final class SHOOTER {
        ...
        public static final int OUTAKE_FEEDER_SPEED = -1000;

        public static final double SHOOT_SCORE_TIME = 1;
    ...
    public final class SWERVE {
        ...
        public static final double TRANSLATE_POWER_FAST = 1;
    ...
    public class APRILTAG_VISION {
        ...
        // red, blue
        public static final ArrayList<Integer> SPEAKER_AIM_TAGS = new ArrayList<>(Arrays.asList(3));
