...
public class ThreeWingNoteMidEndAuto extends BaseAuto{
    ...
    private SwerveTrajectory midNotes = AutonomousPositions.generate(config.setReversed(false).setStartVelocity(0).setEndVelocity(0),
            AutonomousPositions.WING_NOTE_1.translate(0.0, 0.6,Rotation2d.fromDegrees(0)),
            AutonomousPositions.MID_NOTE_1.translate(-0.5, 0)).addRotation(Rotation2d.fromDegrees(30));
    ...
    public void initialize() {
       queue = new CommandQueue(
        ...
        // Robot will drive to midnote 1 and rest
        new FollowerCommand(drive, midNotes)
       );
    }
