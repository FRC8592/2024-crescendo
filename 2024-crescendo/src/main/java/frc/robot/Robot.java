...
public class Robot extends LoggedRobot {
    ...
    public void robotPeriodic() {
        ...
        // //SmartDashboard.putNumber("elevator position in ticks", ejlevator.getPivotAngle()*CONVERSIONS.ANGLE_DEGREES_TO_TICKS*CONVERSIONS.PIVOT_GEAR_RATIO);
