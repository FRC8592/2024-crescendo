...
public class Swerve {
    ...
    public Swerve(NewtonPigeon gyro) {
        ...
        // // set PID constants
        config.setThrottlePID(Constants.SWERVE_THROTTLE_kP, Constants.SWERVE_THROTTLE_kI, Constants.SWERVE_THROTTLE_kD);
        ...
        //         Constants.SWERVE_FRONT_LEFT_MODULE_DRIVE_MOTOR_CAN_ID,
        //         Constants.SWERVE_FRONT_LEFT_MODULE_STEER_MOTOR_CAN_ID,
        //         Constants.SWERVE_FRONT_LEFT_MODULE_STEER_ENCODER_CAN_ID,
        //         Constants.SWERVE_FRONT_LEFT_MODULE_STEER_OFFSET);

        // SwerveModule m_frontRightModule = Mk4iSwerveModuleHelper.createFalcon500(config,
        //         Mk4iSwerveModuleHelper.GearRatio.L2,
        //         Constants.SWERVE_FRONT_RIGHT_MODULE_DRIVE_MOTOR_CAN_ID, Constants.SWERVE_FRONT_RIGHT_MODULE_STEER_MOTOR_CAN_ID,
        //         Constants.SWERVE_FRONT_RIGHT_MODULE_STEER_ENCODER_CAN_ID, Constants.SWERVE_FRONT_RIGHT_MODULE_STEER_OFFSET);

        // SwerveModule m_backLeftModule = Mk4iSwerveModuleHelper.createFalcon500(config,
        //         Mk4iSwerveModuleHelper.GearRatio.L2,
        //         Constants.SWERVE_BACK_LEFT_MODULE_DRIVE_MOTOR_CAN_ID, Constants.SWERVE_BACK_LEFT_MODULE_STEER_MOTOR_CAN_ID,
        //         Constants.SWERVE_BACK_LEFT_MODULE_STEER_ENCODER_CAN_ID, Constants.SWERVE_BACK_LEFT_MODULE_STEER_OFFSET);

        // SwerveModule m_backRightModule = Mk4iSwerveModuleHelper.createFalcon500(config,
        //         Mk4iSwerveModuleHelper.GearRatio.L2,
        //         Constants.SWERVE_BACK_RIGHT_MODULE_DRIVE_MOTOR_CAN_ID, Constants.SWERVE_BACK_RIGHT_MODULE_STEER_MOTOR_CAN_ID,
        //         Constants.SWERVE_BACK_RIGHT_MODULE_STEER_ENCODER_CAN_ID, Constants.SWERVE_BACK_RIGHT_MODULE_STEER_OFFSET);

        SwerveModule m_frontLeftModule = Mk4SwerveModuleHelper.createFalcon500(config,
                Mk4SwerveModuleHelper.GearRatio.L2, Constants.SWERVE_FRONT_LEFT_MODULE_DRIVE_MOTOR_CAN_ID,
                Constants.SWERVE_FRONT_LEFT_MODULE_STEER_MOTOR_CAN_ID,
                Constants.SWERVE_FRONT_LEFT_MODULE_STEER_ENCODER_CAN_ID,
                Constants.SWERVE_FRONT_LEFT_MODULE_STEER_OFFSET);

        SwerveModule m_frontRightModule = Mk4SwerveModuleHelper.createFalcon500(config,
                Mk4SwerveModuleHelper.GearRatio.L2, Constants.SWERVE_FRONT_RIGHT_MODULE_DRIVE_MOTOR_CAN_ID,
                Constants.SWERVE_FRONT_RIGHT_MODULE_STEER_MOTOR_CAN_ID,
                Constants.SWERVE_FRONT_RIGHT_MODULE_STEER_ENCODER_CAN_ID,
                Constants.SWERVE_FRONT_RIGHT_MODULE_STEER_OFFSET);

        SwerveModule m_backLeftModule = Mk4SwerveModuleHelper.createFalcon500(config,
                Mk4SwerveModuleHelper.GearRatio.L2, Constants.SWERVE_BACK_LEFT_MODULE_DRIVE_MOTOR_CAN_ID,
                Constants.SWERVE_BACK_LEFT_MODULE_STEER_MOTOR_CAN_ID,
                Constants.SWERVE_BACK_LEFT_MODULE_STEER_ENCODER_CAN_ID, Constants.SWERVE_BACK_LEFT_MODULE_STEER_OFFSET);

        SwerveModule m_backRightModule = Mk4SwerveModuleHelper.createFalcon500(config,
                Mk4SwerveModuleHelper.GearRatio.L2, Constants.SWERVE_BACK_RIGHT_MODULE_DRIVE_MOTOR_CAN_ID,
                Constants.SWERVE_BACK_RIGHT_MODULE_STEER_MOTOR_CAN_ID,
                Constants.SWERVE_BACK_RIGHT_MODULE_STEER_ENCODER_CAN_ID,
                Constants.SWERVE_BACK_RIGHT_MODULE_STEER_OFFSET);
